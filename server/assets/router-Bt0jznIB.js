...
const appCss = "/assets/styles-BBqRDFSd.css";
const ru = {
  brand: {
    name: "MUNIS USMAN",
  ...
  home: {
    ...
    philosophyBody1: "MUNIS USMAN — это дизайнерский бренд из Ташкента, где вручную создаются предметы носимого искусства: шёлк, шерсть и кожа встречаются с ручной вышивкой и росписью.",
    philosophyBody2: "Мы отпускаем каждую коллекцию ограниченным тиражом и принимаем заказы на авторские изделия — медленная мода, в которой нет ничего случайного.",
    ...
    processBody: "Каждое изделие проходит путь от эскиза и выбора ткани до ручной вышивки и финальной примерки. Мы не торопимся — искусство требует времени.",
  ...
  about: {
    ...
    intro: "MUNIS USMAN — это больше, чем имя на этикетке. Это философия, рождённая в Ташкенте и воплощённая в каждом изделии.",
    story1: "С 2014 года бренд создаёт коллекции, в которых узбекское художественное наследие встречается с современным минимализмом. Ручная вышивка, роспись, тщательно отобранные натуральные ткани — всё это складывается в язык, понятный без слов.",
    story2: "Мы верим в медленную моду: в ценность каждого стежка, в уникальность ограниченного тиража, в возможность создать вещь, которая будет жить вне сезонов.",
    story3: "Каждое изделие — это диалог между мастером и традицией, между шёлковой нитью и рукой, между Ташкентом и миром.",
  ...
  product: {
    ...
    madeToOrderNote: "Каждое изделие создаётся на заказ в нашем ателье в Ташкенте. Срок изготовления — от 4 до 8 недель.",
    inquireTitle: "Заказать это изделие",
    inquireBody: "Напишите нам — мы обсудим размер, детали и индивидуальные пожелания. Каждое изделие создаётся специально для вас.",
    notFound: "Изделие не найдено"
  },
  custom: {
    kicker: "Индивидуальный заказ",
    title: "Создано специально\nдля вас",
    intro: "Мы принимаем ограниченное число индивидуальных заказов. Это возможность стать соавтором изделия, которое существует в единственном экземпляре.",
    step1Title: "01 · Консультация",
    step1Body: "Мы знакомимся, слушаем вашу идею, обсуждаем повод и настроение. Встречаемся онлайн или в ателье.",
    step2Title: "02 · Эскиз и ткани",
    step2Body: "Создаём эскизы, подбираем ткани и нити. Вы получаете образцы и финальную визуализацию до начала работы.",
    step3Title: "03 · Ручная работа",
    step3Body: "Мастера приступают к крою, вышивке и росписи. Весь процесс занимает от 4 до 10 недель.",
    step4Title: "04 · Примерка",
    step4Body: "Финальная примерка, корректировки, упаковка. Изделие отправляется к вам — или вы забираете его лично.",
    formTitle: "Оставьте запрос",
    formBody: "Расскажите нам о своей идее. Мы ответим в течение 48 часов.",
  ...
  journal: {
    ...
    post1Excerpt: "О том, как создаётся ручная вышивка, и почему одно изделие может потребовать сотен часов работы.",
    post1Date: "Март 2025",
    post2Title: "Суzани: живая традиция Ташкента",
    post2Excerpt: "Мы переосмысляем узбекские орнаменты в современных силуэтах — разговор о корнях и будущем.",
    post2Date: "Февраль 2025",
    post3Title: "Шёлк, расписанный вручную",
    post3Excerpt: "Процесс создания наших палантинов — от белого шёлка до ботанических мотивов.",
    post3Date: "Январь 2025"
  },
  contact: {
    kicker: "Контакты",
    title: "Давайте поговорим",
    subtitle: "Мы отвечаем на письма в течение 48 часов. Для срочных вопросов пишите в Instagram.",
...
const en = {
  ...
  cta: {
    ...
    customOrder: "Order Custom Piece",
  ...
  home: {
    heroKicker: "Couture · Since 2014",
    philosophyKicker: "Philosophy",
    philosophyTitle: "Each piece is a story,\nshaped by hand,\ntime and tradition.",
    philosophyBody1: "MUNIS USMAN is a designer brand from Tashkent — a place where wearable art is made by hand. Silk, wool and leather meet hand embroidery and painting.",
    philosophyBody2: "Every collection is limited, and every bespoke piece is made to order. Slow fashion, where nothing is accidental.",
    featuredKicker: "Featured",
    featuredTitle: "Collection",
    featuredSubtitle: "Limited editions and made-to-order pieces",
    processKicker: "Craft",
    processTitle: "From idea to object",
    processBody: "Every piece travels from sketch and fabric selection through hand embroidery to a final fitting. We do not rush — art asks for time.",
  ...
  about: {
    kicker: "About",
    title: "A heritage, handwoven\nsince 2014",
    intro: "MUNIS USMAN is more than a name on a label. It is a philosophy born in Tashkent, shaped into every piece we make.",
    story1: "Since 2014 the brand has created collections where Uzbek artistic heritage meets modern minimalism. Hand embroidery, hand-painted silk, carefully chosen natural fabrics — a language that speaks without words.",
    story2: "We believe in slow fashion: in the value of each stitch, in the uniqueness of a limited edition, in the possibility of making things that live outside the seasons.",
    story3: "Every piece is a dialogue between maker and tradition, between silk thread and hand, between Tashkent and the world.",
    valuesTitle: "Our values",
    value1Title: "Handcrafted",
    value1Body: "Every stitch is the result of hours of careful, human work.",
    value2Title: "Heritage",
    value2Body: "We draw from Uzbek culture and reimagine it for today.",
    value3Title: "Slow fashion",
    value3Body: "Limited editions and made-to-order only — never mass production."
  },
  collection: {
    kicker: "Collection",
    title: "Wearable Art",
    subtitle: "Limited Editions · Made to Order",
    limited: "Limited edition",
    madeToOrder: "Made to order",
    item1Name: "Emerald Dress",
    item1Desc: "Silk with hand-embroidered gold thread",
    item2Name: "Pomegranate Scarf",
    item2Desc: "Silk, hand-painted botanical motifs",
    item3Name: "Tashkent Coat",
    item3Desc: "Wool with hand embroidery on shoulders and cuffs",
    item4Name: "Sand Dress",
    item4Desc: "Silk, hand-painted peonies with gold accents",
    item5Name: "Ornament Case",
    item5Desc: "Green silk phone case with hand-embroidered gold",
    item6Name: "Dawn Silk",
    item6Desc: "Suzani-inspired embroidery in burgundy and gold"
  },
  product: {
    ...
    madeToOrderNote: "Each piece is made to order in our atelier in Tashkent. Lead time: 4 to 8 weeks.",
    inquireTitle: "Order this piece",
    inquireBody: "Write to us — we will discuss size, details and personal wishes. Each piece is made especially for you.",
    notFound: "Piece not found"
  },
  custom: {
    kicker: "Custom Order",
    title: "Made especially\nfor you",
    intro: "We accept a limited number of custom orders. It is your chance to become a co-author of a piece that exists only once.",
    step1Title: "01 · Consultation",
    step1Body: "We meet, listen to your idea, talk about the occasion and the mood. Online or at the atelier.",
    step2Title: "02 · Sketch and fabric",
    step2Body: "We create sketches, select fabrics and threads. You receive samples and a final visualisation before work begins.",
    step3Title: "03 · Handwork",
    step3Body: "Our makers begin cutting, embroidery and painting. The whole process takes 4 to 10 weeks.",
    step4Title: "04 · Fitting",
    step4Body: "Final fitting, adjustments, packaging. The piece is sent to you — or collected in person.",
    formTitle: "Send your request",
    formBody: "Tell us about your idea. We reply within 48 hours.",
    formNamePlaceholder: "Your name",
    formEmailPlaceholder: "Email",
    formMessagePlaceholder: "Describe your idea — occasion, mood, desired materials",
  ...
  journal: {
    ...
    post1Excerpt: "How hand embroidery is made, and why a single piece can take hundreds of hours of work.",
    post1Date: "March 2025",
    post2Title: "Suzani: Tashkent's living tradition",
    post2Excerpt: "We reimagine Uzbek ornaments in modern silhouettes — a conversation between roots and future.",
    post2Date: "February 2025",
    post3Title: "Silk, painted by hand",
    post3Excerpt: "The making of our scarves — from plain silk to botanical motifs.",
    post3Date: "January 2025"
  },
  contact: {
    kicker: "Contact",
    title: "Let's talk",
    subtitle: "We reply to emails within 48 hours. For urgent enquiries write us on Instagram.",
...
function LanguageProvider({ children }) {
  ...
  const t = (key) => resolveKey(dictionaries[lang], key);
...
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 font-display text-2xl text-foreground", children: "Страница не найдена" }),
...
const Route$7 = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "MUNIS USMAN — дизайнерский бренд носимого искусства из Ташкента. Ручная вышивка, ограниченные серии, изделия на заказ с 2014 года."
      },
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(LanguageProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) });
}
const $$splitComponentImporter$6 = () => import("./journal-ChhDIpd0.js");
const Route$6 = createFileRoute("/journal")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Истории из ателье — о ремесле, вдохновении и процессе."
    }, {
      property: "og:title",
      content: "Journal · MUNIS USMAN"
    }, {
      property: "og:description",
      content: "Stories from the atelier — on craft, inspiration and process."
    }]
  })
});
const $$splitComponentImporter$5 = () => import("./custom-rS58gnSk.js");
const Route$5 = createFileRoute("/custom")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Создаём изделия на заказ. Консультация, эскизы, ручная работа."
    }, {
      property: "og:title",
      content: "Custom Order · MUNIS USMAN"
    }, {
      property: "og:description",
      content: "Made especially for you — consultation, sketches, handwork."
    }]
  })
});
const $$splitComponentImporter$4 = () => import("./contact-DAqG206h.js");
const Route$4 = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Ташкент, Узбекистан. info@munisusman.com · Instagram @munisusman"
    }, {
      property: "og:title",
      content: "Contact · MUNIS USMAN"
    }, {
      property: "og:description",
      content: "Tashkent, Uzbekistan. Let's talk."
    }]
  })
});
const $$splitComponentImporter$3 = () => import("./about-B6HefBvN.js");
const Route$3 = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "История дизайнерского бренда MUNIS USMAN — Ташкент, с 2014 года."
    }, {
      property: "og:title",
      content: "About · MUNIS USMAN"
    }, {
      property: "og:description",
      content: "A heritage, handwoven since 2014. Tashkent, Uzbekistan."
    }]
  })
});
const $$splitComponentImporter$2 = () => import("./index-B5OlGj0U.js");
const Route$2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Дизайнерский бренд носимого искусства из Ташкента. Ручная вышивка и роспись, ограниченные серии, изделия на заказ с 2014 года."
    }, {
      property: "og:title",
      content: "MUNIS USMAN — Wearable Art. Crafted in Tashkent."
    }, {
      property: "og:description",
...
const $$splitComponentImporter$1 = () => import("./collection.index-Zer6z_33.js");
const Route$1 = createFileRoute("/collection/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Ограниченные серии и изделия на заказ. Ручная вышивка, шёлк, шерсть."
    }, {
      property: "og:title",
      content: "Collection · MUNIS USMAN"
    }, {
      property: "og:description",
      content: "Limited editions and made-to-order wearable art."
    }]
  })
});
const collection1 = "/assets/collection-1-BDqI-WyH.jpg";
const collection3 = "/assets/collection-3-Ck3OkPD-.jpg";
const fabricDetails = "/assets/fabric-details-UaMxLjrF.jpg";
const phoneCase = "/assets/phone-case-C0ZrJmH7.jpg";
const embroideryHands = "/assets/embroidery-hands-DPvpvdNB.jpg";
const journal3 = "/assets/journal-3-B1pJqC42.jpg";
const products = [
  {
    slug: "emerald-dress",
    image: collection1,
...
const $$splitNotFoundComponentImporter = () => import("./collection._slug-DGSOqJHF.js");
const $$splitComponentImporter = () => import("./collection._slug-RQ-X9Uel.js");
const Route2 = createFileRoute("/collection/$slug")({
...
const CustomRoute = Route$5.update({
  id: "/custom",
  path: "/custom",
  getParentRoute: () => Route$7
});
...
const CollectionIndexRoute = Route$1.update({
  id: "/collection/",
  path: "/collection/",
  getParentRoute: () => Route$7
});
const CollectionSlugRoute = Route2.update({
  id: "/collection/$slug",
