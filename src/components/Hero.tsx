    ...
    <section className="relative w-full overflow-hidden bg-forest-deep">
      <div className="relative aspect-[3/4] w-full sm:aspect-auto sm:h-[78vh] sm:min-h-[520px]">
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center px-6 text-center">
          ...
          />
          <p className="mt-3 font-display italic text-cream text-[11px] sm:text-xs tracking-[0.32em] uppercase animate-fade-up">
            Couture &amp; Accessories
          </p>
          <p className="mt-6 max-w-[18rem] text-[12px] leading-relaxed text-cream/90 sm:max-w-md sm:text-sm animate-fade-up">
            {t("home.heroIntro")}
          </p>
        </div>
      </div>
